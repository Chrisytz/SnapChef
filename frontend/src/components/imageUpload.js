...
function ImageUpload() {
    ...
    async function getRecipe(ingredients) {
        const response = await cohere.generate({
            ...
            - The ingredients of the recipe should be in a nested dictionary with key "ingredients" and inside that nested dictionary, each ingredient should have the key be the ingredient name and the value be the quantity/details.
            - Finally, the steps to prepare the recipe should be in a list with the key "steps".
